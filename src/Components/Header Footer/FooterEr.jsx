    ...
    <footer className="footer bg-light py-4">
      <div className="container-fluid">
        <div className="row">
          ...
          <div className="d-flex justify-content-center justify-content-lg-start align-items-center" style={{ height: '100px' }}>
  <img src="https://i.postimg.cc/xTNYpnxL/ertitech.png" alt="Logo" className="img-fluid lg-mb-3" style={{ maxHeight: '40px' }} />
</div>
          ...
          <a 
            ...
            ><img src="https://i.postimg.cc/85FLDjdy/facebook.png" alt="Facebook" className="img-fluid me-2 socialicon"  /></a>
                          <a 
              href="https://www.instagram.com/ertitech/?hl=en"
              target="_blank"
              rel="noopener noreferrer"
            >
<img src="https://i.postimg.cc/5NmYhBd4/instagram.png" alt="Instagram" className="img-fluid mx-2 socialicon"  /></a>
<a 
              href="https://www.linkedin.com/company/ertitech-solutions-private-limited/people/"
              target="_blank"
              rel="noopener noreferrer"
            ><img src="https://i.postimg.cc/ZqWWvX9n/linked-in.png" alt="LinkedIn" className="img-fluid mx-2 socialicon"  /></a>
              <a 
              href="https://api.whatsapp.com/send?phone=8122686806&text=YOUR_MESSAGE" 
              target="_blank"
              rel="noopener noreferrer"
            ><img src="https://i.postimg.cc/65BTf87D/whatsapp.png" alt="WhatsApp" className="img-fluid mx-2 socialicon"  /></a>
            </div>
          </div>
        </div>
      </div>
