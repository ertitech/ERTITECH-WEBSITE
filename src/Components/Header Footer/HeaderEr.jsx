...
const HeaderEr = () => {
  ...
  return (
    <>
      <Navbar expand="md" className="header-navbar">
        ...
        <Navbar.Collapse id="basic-navbar-nav" className="justify-content-center">
          <Nav className="mr-auto container-home borderYtoX">
            <NavLink to="/" text="Home" location={location} onClick={handleClose} />
            <NavLink to="/AboutUs" text="About Us" location={location} onClick={handleClose} />
            <NavLink to="/Products" text="Products" location={location} onClick={handleClose} />
            <NavLink to="/Pricings" text="Pricings" location={location} onClick={handleClose} />
            <NavLink to="/ContactUs" text="Contact Us" location={location} onClick={handleClose} />
          </Nav>
        </Navbar.Collapse>
      ...
      {/* Offcanvas component */}
      <Offcanvas show={showOffcanvas} onHide={handleClose} placement="end" style={{ width: offcanvasWidth }}>
        ...
        <Offcanvas.Body>
          <Nav className="flex-column">
            ...
            <NavLink to="/Pricings" text="Pricings" location={location} onClick={handleClose} />
            <NavLink to="/ContactUs" text="Contact Us" location={location} onClick={handleClose} />
            <NavLink to="/Login" text="Sign Up/Login" location={location} onClick={handleClose} />
          </Nav>
        </Offcanvas.Body>
      </Offcanvas>
    </>
